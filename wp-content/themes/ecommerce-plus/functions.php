      ...
      <div class="col-sm-4 col-xs-12">
        <div id="top-social-right" class="header_social_links">
          <ul>
            ...
            <?php if ($options['social_facebook_link'] !='') { ?><li> <a href="<?php echo esc_url($options['social_facebook_link']); ?>" class="social_links_header_0 facebook" target="_blank"> <span class="ts-icon"> <i class="fa fa-facebook-f"></i> </a></li> <?php } ?>
...
function ecommerce_plus_general_admin_notice(){
         ...
         $msg = sprintf('<div data-dismissible="disable-done-notice-forever" class="notice notice-info" >
		 		<h3>%1$s</h3><p>
				<a href=%2$s style="text-decoration:none;" class="button button-primary" target="_blank"  > %3$s </a>
				<span>%4$s</span>
				<a href="?ecommerce_plus_notice_dismissed" style="text-decoration: none; float: right;" >%5$s</a></p></div>',
				esc_html__('Get Most out of the theme','ecommerce-plus'),
				esc_url('https://www.ceylonthemes.com/product/wordpress-ecommerce-theme'),			
				esc_html__('Tutorials & Download eCommere Extra plugin','ecommerce-plus'),
				esc_html__('Create a page using home-page template, set it as home page and use customizer to edit sections. Use widgets with prefix (+) to create post sliders, product sliders, carousels, grids etc.','ecommerce-plus'),	
